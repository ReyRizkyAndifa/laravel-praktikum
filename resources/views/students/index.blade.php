<x-default-layout title="Student" section_title="Students">
    ...
    @can('store-student')
    <div class="flex">
        <a href="{{ route('students.create') }}" class="bg-green-50 text-green-500 border border-green-500 px-3 py-2 flex items-center gap-2">
            <div class="ph ph-plus block text-green-500"></div>
            Add Student
        </a>
    </div>
    @endcan
                ...
                @forelse ($students as $student)
                    <tr class="border-b border-zinc-200 hover:bg-zinc-100">
                        ...
                        <td class="py-3 px-6 flex justify-center gap-2">
                            <a href="{{ route('students.show', $student->id) }}" class="bg-blue-50 border border-blue-500 p-2 inline-block">
                                <i class="ph ph-eye block text-blue-500"></i>
                            </a>
                        @can('edit-student')
                            <a href="{{ route('students.edit', $student->id) }}" class="bg-yellow-50 border border-yellow-500 p-2 inline-block">
